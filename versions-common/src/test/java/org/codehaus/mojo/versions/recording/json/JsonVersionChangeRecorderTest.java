...
class JsonVersionChangeRecorderTest {
    ...
    public void setup() {
        ...
        recorder = new JsonVersionChangeRecorderFactory().create(null, mojoExecution, new SystemStreamLog());
    }
    ...
    void testCreateFileAndSubdirectories() throws Exception {
        ...
        try {
            createChanges();
            Path reportPath = tempDir.resolve("dir1").resolve("dir2").resolve("report.json");
            ...
            assertThat(
                    output,
                    containsString(
                            "{\"updateClass\":\"dependency\",\"kind\":\"dependency-update\",\"groupId\":\"org.codehaus\",\"artifactId\":\"example0\",\"oldVersion\":\"0.0.1\",\"newVersion\":\"0.0.2\"}"));
            assertThat(
                    output,
                    containsString(
                            "{\"updateClass\":\"dependency\",\"kind\":\"dependency-management-update\",\"groupId\":\"org.codehaus\",\"artifactId\":\"example1\",\"newVersion\":\"2.0.0\"}"));
    ...
    void testAppend() throws Exception {
        ...
        try {
            ...
            assertThat(
                    output,
                    containsString(
                            "{\"versionChanges\":[{\"updateClass\":\"dependency\",\"kind\":\"dependency-update\",\"groupId\":\"org.codehaus\",\"artifactId\":\"example0\",\"oldVersion\":\"0.0.1-SNAPSHOT\",\"newVersion\":\"0.0.1\"}],\"goal\":\"test\",\"date\":\"2025-10-03T05:05:38.437013556Z\"}"));
            assertThat(
                    output,
                    containsString(
                            "{\"updateClass\":\"dependency\",\"kind\":\"dependency-update\",\"groupId\":\"org.codehaus\",\"artifactId\":\"example0\",\"oldVersion\":\"0.0.1-SNAPSHOT\",\"newVersion\":\"0.0.1\"}"));
            assertThat(
                    output,
                    containsString(
                            "{\"updateClass\":\"dependency\",\"kind\":\"dependency-update\",\"groupId\":\"org.codehaus\",\"artifactId\":\"example0\",\"oldVersion\":\"0.0.1\",\"newVersion\":\"0.0.2\"}"));
