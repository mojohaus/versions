...
class XmlVersionChangeRecorderTest {
    ...
    public void setup() {
        ...
        recorder = new XmlVersionChangeRecorderFactory()
                .create(null, mojoExecution, Collections.singletonMap("legacy", "false"));
    }
    ...
    void testCreateFileAndSubdirectories() throws Exception {
        ...
        try {
            ...
            assertThat(
                    output,
                    containsString(
                            "<dependencyUpdate kind=\"dependency-management-update\" groupId=\"org.codehaus\" artifactId=\"example1\" oldVersion=\"1.0.0\" newVersion=\"2.0.0\"/>"));
        } finally {
