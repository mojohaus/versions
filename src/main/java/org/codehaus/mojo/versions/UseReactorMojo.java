    ...
    extends AbstractVersionsDependencyUpdaterMojo
{
    ...
    private void useReactor( ModifiedPomXMLEventReader pom, MavenProject parent ) throws XMLStreamException
    {
        for ( Object reactorProject : session.getProjectDependencyGraph().getSortedProjects() )
        {
