...
class CsvVersionChangeRecorderTest {
    ...
    public void setup() {
        ...
        recorder = new CsvVersionChangeRecorderFactory().create(null, mojoExecution, new SystemStreamLog());
    }
        ...
        try {
            ...
            assertThat(
                    ...
                    allOf(
                            hasItem(
                                    matchesPattern(
                                            "[^;]+;test;[^;]+;dependency;dependency-update;org.codehaus;example0;;0.0.1;0.0.2;")),
                            hasItem(
                                    matchesPattern(
                                            "[^;]+;test;[^;]+;dependency;dependency-management-update;org.codehaus;example1;;;2.0.0;"))));
        } finally {
    ...
    void testAppend() throws Exception {
        ...
        assertThat(
                ...
                allOf(
                        hasItem(
                                matchesPattern(
                                        "[^;]+;test;[^;]+;dependency;dependency-update;org.codehaus;example0;;0.0.1-SNAPSHOT;0.0.1;")),
