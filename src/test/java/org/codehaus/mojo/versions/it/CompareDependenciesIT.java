...
class CompareDependenciesIT {
  ...
  @MavenTest(goals = {"${project.groupId}:${project.artifactId}:${project.version}:display-dependency-updates"},
  systemProperties = {"remotePom=localhost:dummy-bom-pom:1.0", "reportMode=false",
   "updatePropertyVersions=true"})
  void it_compare_dependencies_001(MavenExecutionResult result, MavenProjectResult project) {
